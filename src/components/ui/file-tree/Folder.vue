<template>
  <div class="relative h-full overflow-hidden">
    <div class="flex cursor-pointer items-center gap-1 rounded-md text-sm transition-all duration-200" :class="[
      cn(
    ...
    ]" :dir="direction" @click="onTriggerClick">
      <FolderOpenIcon v-if="isExpanded" :size="16"></FolderOpenIcon>
      <FolderClosedIcon v-else :size="16">
      </FolderClosedIcon>
...
import { TreeIndicator } from "./index";
