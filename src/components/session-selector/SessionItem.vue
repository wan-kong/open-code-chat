<template>
    <SidebarMenuItem>
        <SidebarMenuButton :is-active="isActive" @click="$emit('select', session)" :class="['group relative cursor-pointer transition-all duration-200 hover:scale-[1.02] hover:shadow-sm',
            isActive && 'bg-gradient-to-r from-primary/10 to-primary/5 text-primary border-none']">
